...
const ReportsPage = () => {
    ...
    const paginated = filteredUsers.slice((currentPage - 1) * ROWS_PER_PAGE, currentPage * ROWS_PER_PAGE);
                        ...
                        >
                            {paginated.map((user) => (
                                ...
                                >
                                    ...
                                    <td className="space-x-1 whitespace-nowrap p-3">
                                        {user.filters?.map((f, i) => (
                                            <span
                                                key={i}
                                                className={`rounded-md px-2 py-0.5 text-xs font-medium text-white ${FILTER_COLORS[f - 1]}`}
                                            >
                                                {f}
                                            </span>
                                        ))}
