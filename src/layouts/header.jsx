...
export const Header = ({ setCollapsed }) => {
    // Get current theme and theme setter
    const { theme, setTheme } = useTheme();
    // Track if the page is scrolled for header styling
    ...
    return (
        ...
        >
            <div className="flex items-center gap-x-3">
                ...
                {/* App title */}
                <h1
                    className="font-mono text-3xl font-semibold tracking-wide text-slate-900 dark:text-white"
